...
const WIDGET_REGISTRY = {
    gym: { label: 'Gym', component: GymWidget },
    runs: { label: 'Runs', component: RunsWidget },
    weather: { label: 'Wetter', component: WeatherWidget },
    github: { label: 'GitHub Repos', component: GitHubWidget },
    devices: { label: 'Geräte', component: DevicesWidget },
    cloudflare: { label: 'Cloudflare', component: CloudflareWidget },
    domains: { label: 'Domains', component: DomainsWidget },
}
